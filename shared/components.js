  ...
  connectedCallback() {
    ...
    this.innerHTML = `
			<header>
					...
					<!-- Navbar -->
					<nav class="navbar">
							<a href="/Home/index.html"><img class="navbar__logo" src="/Home/assets/logo svo branco.png"
											alt="Logo SVO" /></a>
							...
							<div class="navbar__theme-toggle navbar__theme-toggle--hidden-sm">
									<input type="checkbox" id="navbar__theme-toggle-checkbox" class="navbar__theme-toggle-checkbox" />
									<label for="navbar__theme-toggle-checkbox" class="navbar__theme-toggle-label">
							...
							<button class="navbar__accessibility-font-size-btn navbar__accessibility-font-size-btn--hidden-sm"
									id="fontSizeButton">
					...
					<div class="navbar__mobile" id="mobile-menu">
							...
							<ul class="navbar-mobile__list">
									...
									<li class="navbar__item">
											<a class="navbar__link" id="talkWithUs" href="/Services/index.html" data-link>Solicitar Remoção</a>
									</li>
							...
							<div class="mobile-navbar__bottom">
									...
									<div class="navbar__theme-toggle mobile-navbar__theme-toggle">
											<input type="checkbox" id="navbar__theme-toggle-checkbox2" class="navbar__theme-toggle-checkbox" />
											<label for="navbar__theme-toggle-checkbox2" class="navbar__theme-toggle-label">
													<span class="navbar__theme-toggle-slider">
															<i class="fa-solid fa-sun icon icon-sun"></i>
															<i class="fa-solid fa-moon icon icon-moon"></i>
													</span>
						...
						<div class="footer__section">
							...
							<div class="footer__elements">
								<div class="footer__element footer__element--align">
									<a class="footer__link-social" target="_blank"
										href="https://www.instagram.com/hemose_lacen_svo/">
										<svg class="footer__social-sgv" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
								...
								<div class="footer__element footer__element--align">
									<a class="footer__link-social" target="_blank" href="https://x.com/FSPH_SE">
										<svg class="footer__social-sgv" xmlns="http://www.w3.org/2000/svg" width="20" height="20"
											...
											<path
												d="M15.75 0.5H18.8171L12.1171 8.1239L20 18.5H13.8286L8.99143 12.2082L3.46286 18.5H0.392857L7.55857 10.3427L0 0.501419H6.32857L10.6943 6.25126L15.75 0.5ZM14.6714 16.6728H16.3714L5.4 2.23219H3.57714L14.6714 16.6728Z"
												fill="#F8F8F8" />
										</svg>
